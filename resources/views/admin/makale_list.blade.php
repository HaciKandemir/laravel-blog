                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($makaleler as $makale)
                        <tr>
                            ...
                            <td>
                                <a href="/makale/{{$makale->id}}/edit" class="eylem btn btn-primary " data-toggle="tooltip" title="Düzenle"><i class="fa fa-edit"></i></a>
                                <a href="{!! route('makale.destroy', $makale->id) !!}" class="eylem btn btn-danger " data-toggle="tooltip" title="Sil" data-method="delete" data-confirm="Are you sure?"><i class="fa fa-remove"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
